          ...
          <div>
            ...
            <div className="flex flex-wrap justify-center -m-2" data-aos="fade-up" data-aos-delay="400" data-aos-anchor="[data-aos-id-tabs]">
              ...
              >
                ...
                <span className="text-gray-400 group-hover:text-gray-200 transition-colors duration-150 ease-in-out">Cloud Native</span>
              </button>
              <button
              ...
              >
                ...
                <span className="text-gray-400 group-hover:text-gray-200 transition-colors duration-150 ease-in-out">Free from toil</span>
              </button>
              <button
              ...
              >
                ...
                <span className="text-gray-400 group-hover:text-gray-200 transition-colors duration-150 ease-in-out">Integration</span>
              </button>
              <button
              ...
              >
                ...
                <span className="text-gray-400 group-hover:text-gray-200 transition-colors duration-150 ease-in-out">Clusterless</span>
              </button>
              <button
              ...
              >
                ...
                <span className="text-gray-400 group-hover:text-gray-200 transition-colors duration-150 ease-in-out">Developers</span>
              </button>
            </div>
                ...
                >
                  <article className="relative max-w-md mx-auto md:max-w-none">
                    <figure className="md:absolute md:inset-y-0 md:right-0 md:w-1/2">
                      <Image className="w-full h-full object-cover" src={TabsImage01} width={516} height={387} alt="Cloud Native" />
                    </figure>
                    <div className="relative bg-gray-800 py-8 md:py-16 px-6 md:pr-16 md:max-w-lg lg:max-w-xl">
                      <h4 className="h4 mb-2">Cloud Native from start to finish</h4>
                      <p className="text-lg text-gray-400">Kubespaces was born in the cloud native communities, leverage many CNCF projects and is built upon solid open source foundations.</p>
