        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="pt-10 pb-12 md:pt-16 md:pb-20">
            ...
            <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
              <h2 className="h2 mb-4" data-aos="fade-up">Ask for a consultation, free of charge</h2>
              <p className="text-xl text-gray-400" data-aos="fade-up" data-aos-delay="200">Get in touch to learn more about Kubespaces' use cases and how we can help you.</p>
            </div>
            ...
            <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-3 lg:gap-16 items-start md:max-w-none">
              ...
              <div className="relative flex flex-col items-center" data-aos="fade-up">
                ...
                <h4 className="h4 mb-2"><span className="text-gray-400">1</span>. Cloud Native</h4>
                <p className="text-lg text-gray-400 text-center">Cloud Native consultation.</p>
              </div>
              ...
              <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="200">
                ...
                <h4 className="h4 mb-2"><span className="text-gray-400">2</span>. App Modernization</h4>
                <p className="text-lg text-gray-400 text-center">Ask us how to migrate your applications (monoliths and microservices) to Kubespaces.</p>
              </div>
              ...
              <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="400">
                ...
                <p className="text-lg text-gray-400 text-center">Ask us how to onboard and skill up your teams.</p>
              </div>
