        ...
        <div className="pt-10 pb-12 md:pt-16 md:pb-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <p
              ...
              data-aos-delay="200"
            >
              Focus on what matters: your developers. Provide them the best
              tools with zero-touch infrastructure.
            </p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-3 lg:gap-16 items-start md:max-w-none">
            ...
            >
              ...
              <p className="text-lg text-gray-500 text-center">
                ...
                deploy, monitor and expose their microservices applications
                easily and reliably.
              </p>
            </div>
            ...
            >
              ...
              <p className="text-lg text-gray-500 text-center">
                ...
                consumption, and providing all your developers with the same
                platform.
              </p>
            </div>
          </div>
