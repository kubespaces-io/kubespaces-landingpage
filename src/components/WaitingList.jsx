                    ...
                    {showSuccessMessage ? (
                        ...
                        <form
                            ...
                            <div className="flex flex-col md:flex-row md:justify-between justify-center items-center gap-4">
                                <label htmlFor="name" className="flex flex-col w-full md:text-left">
                                ...
                                <label htmlFor="email" className="flex flex-col w-full md:text-left">
...
export default SectionWrapper(WaitingList, 'waiting-list')
