      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Bringing developer productivity to blossom</h2>
            <p className="text-xl text-gray-400">We love developers (we are ones ourselves) so we build a product that ourselves wish was there.</p>
          </div>
          ...
          <div className="max-w-3xl mx-auto -my-4 md:-my-6" data-aos-id-timeline>
            ...
            <div className="relative py-4 md:py-6 pl-24" data-aos="fade-up" data-aos-anchor="[data-aos-id-timeline]">
              <div className="pl-2">
                ...
                <div className="flex items-center mb-3">
                  ...
                  <h4 className="h4">The idea of Kubespaces started in Amsterdam</h4>
                </div>
                <p className="text-lg text-gray-400">Based on our experience at small and big customers, we started thinking about how to generalize a Namespace-as-a-service offering.</p>
              </div>
            </div>
            ...
            <div className="relative py-4 md:py-6 pl-24" data-aos="fade-up" data-aos-delay="200" data-aos-anchor="[data-aos-id-timeline]">
              <div className="pl-2">
                <div className="font-architects-daughter text-xl text-purple-600 mb-2">Development</div>
                <div className="flex items-center mb-3">
                  ...
                  <div className="absolute left-0 h-full px-px bg-gray-800 ml-20 self-start transform -translate-x-1/2 translate-y-3" aria-hidden="true"></div>
                  <div className="absolute left-0 w-2 h-2 bg-purple-600 border-4 box-content border-gray-900 rounded-full ml-20 transform -translate-x-1/2" aria-hidden="true"></div>
                  <h4 className="h4">We develop the first prototype and assembled a team</h4>
                </div>
                <p className="text-lg text-gray-400">We recruit an enthusiastic founding team and started thinking about our mission and core values.</p>
              </div>
            </div>
            ...
            <div className="relative py-4 md:py-6 pl-24" data-aos="fade-up" data-aos-delay="400" data-aos-anchor="[data-aos-id-timeline]">
              <div className="pl-2">
                ...
                <p className="text-lg text-gray-400">We released our first MVP and found just the right product market fit for our platform; we grow our customer base and set the foundation for an organic expansion.</p>
              </div>
            </div>
            ...
            <div className="relative py-4 md:py-6 pl-24" data-aos="fade-up" data-aos-delay="600" data-aos-anchor="[data-aos-id-timeline]">
              <div className="pl-2">
                ...
                <div className="flex items-center mb-3">
                  <div className="absolute left-0 inline-flex text-sm font-semibold py-1 px-3 text-green-600 bg-green-200 rounded-full">2025</div>
                  <div className="absolute left-0 w-2 h-2 bg-purple-600 border-4 box-content border-gray-900 rounded-full ml-20 transform -translate-x-1/2" aria-hidden="true"></div>
                  <h4 className="h4">1 million happy customers!</h4>
                </div>
                <p className="text-lg text-gray-400">Do you want to be part of it? Sign up!</p>
              </div>
            </div>
