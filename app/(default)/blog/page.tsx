          ...
          <div className="pt-32 pb-12 md:pt-40 md:pb-20">
            ...
            <div className="max-w-3xl pb-12 md:pb-20 text-center md:text-left">
              <h1
                ...
                data-aos="fade-up"
              >
                Refreshing news for developers and engineers
              </h1>
            </div>
            ...
            <div className="pb-12 md:pb-20">
              <article className="max-w-sm mx-auto md:max-w-none grid md:grid-cols-2 gap-6 md:gap-8 lg:gap-12 xl:gap-16 items-center">
                ...
                <div data-aos="fade-left" data-aos-delay="200">
                  ...
                  <p className="text-lg text-gray-600 grow">
                  ...
                  <footer className="flex items-center mt-4">
                    ...
                    <div>
                      <Link
                        href="#"
                        className="font-medium text-gray-600 hover:text-gray-100 transition duration-150 ease-in-out"
                      >
                        {featuredPost.author}
                      </Link>
            ...
            <div className="max-w-sm mx-auto md:max-w-none">
              {/*  Section title */}
              <h2
                className="text-4xl font-bold text-gray-800 md:text-2xl"
                data-aos="fade-up"
              >
                Latest articles
              </h2>
